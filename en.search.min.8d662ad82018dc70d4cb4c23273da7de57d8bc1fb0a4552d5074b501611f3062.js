...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.9e0fb485ee265c14f4d20bbdbd38bc81a94c050650021cf2c187033c66328d2e.js',function(){input.required=false;search();});}
