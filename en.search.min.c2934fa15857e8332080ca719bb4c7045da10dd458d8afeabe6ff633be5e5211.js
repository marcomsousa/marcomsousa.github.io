...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.909a2fe88133629852b63b06607f0c88c690bc2868a0f96a3d48cfbdfd113a94.js',function(){input.required=false;search();});}
