...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3ad2095bc26a1fecd4e01ea41d5814624f083952bdef30b4e83a7dec4b1feeae.js',function(){input.required=false;search();});}
