...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.d164ecd81155a492c266fc63613acda4d9ecce3464ab2ab956ff2a346d0db9d0.js',function(){input.required=false;search();});}
