...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b804bd327a694fa35ba83fc738b00449c3ffbbb3839d5eea824b133644ef4be5.js',function(){input.required=false;search();});}
