...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.3bf18b49a4f22fdada74ce1bf0c9fcb5be1e1bc313a0f7bfe7a5f51f789442ff.js',function(){input.required=false;search();});}
