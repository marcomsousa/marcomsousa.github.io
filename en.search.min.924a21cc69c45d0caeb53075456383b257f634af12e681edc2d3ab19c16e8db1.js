...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.4e846442ff08ffe85f833abb2aa08c29181a7892d80a5821acc0623ecd999974.js',function(){input.required=false;search();});}
