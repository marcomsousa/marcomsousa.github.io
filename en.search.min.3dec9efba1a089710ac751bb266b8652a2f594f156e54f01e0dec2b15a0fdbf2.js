...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b8467094d060e86530da47123917bbc6d1a545629daf9a3a2d21e20b3b48cd50.js',function(){input.required=false;search();});}
